(() => {
    ...
    var S = u((ct, P) => {
        var _ = [];
        for (c = 0; c < 256; ++c) _[c] = (c + 256).toString(16).substr(1);
        var c;
        function K(i, t) {
            var e = t || 0,
                s = _;
    ...
    var F = u((lt, b) => {
        ...
        function tt(i, t, e) {
            ...
            var r = i.clockseq !== void 0 ? i.clockseq : U,
                ...
                a = i.nsecs !== void 0 ? i.nsecs : D + 1,
                E = o - C + (a - D) / 1e4;
            if (
                (E < 0 && i.clockseq === void 0 && (r = (r + 1) & 16383),
                (E < 0 || o > C) && i.nsecs === void 0 && (a = 0),
                a >= 1e4)
            )
                throw new Error(
                    "uuid.v1(): Can't create more than 10M uuids/sec",
                );
            ((C = o), (D = a), (U = r), (o += 122192928e5));
            var l = ((o & 268435455) * 1e4 + a) % 4294967296;
            ((n[s++] = (l >>> 24) & 255),
                (n[s++] = (l >>> 16) & 255),
                (n[s++] = (l >>> 8) & 255),
                (n[s++] = l & 255));
            ...
            ((n[s++] = (d >>> 8) & 255),
                ...
                (n[s++] = (r >>> 8) | 128),
                (n[s++] = r & 255));
            for (var z = i.node || Z, f = 0; f < 6; ++f) n[s + f] = z[f];
            return t || X(n);
        }
        b.exports = tt;
    });
    ...
    var q = (i) => {
        i.data("notificationComponent", ({ notification: t }) => ({
            ...
            configureAnimations() {
                let e;
                Livewire.interceptMessage(({ onFinish: s, onSuccess: n }) => {
                    requestAnimationFrame(() => {
                        ...
                        (s(() => {
                            ...
                            n(({ payload: a }) => {
                                a?.snapshot?.data
                                    ?.isFilamentNotificationsComponent && e();
                            }));
                    });
                });
            },
    ...
    window.FilamentNotificationAction = p;
    window.FilamentNotificationActionGroup = w;
    window.FilamentNotification = v;
